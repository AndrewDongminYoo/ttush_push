...
| A screen-reader user can select an explorer and activate a normal or Push destination | Verification pending | [`round_board.dart`](../../lib/game/view/round_board.dart) projects actionable explorer and destination semantics, and [`game_page_accessibility_test.dart`](../../test/game/view/game_page_accessibility_test.dart) activates normal and Push moves through those semantics. The recorded VoiceOver review is not a TalkBack result, so manual Android verification remains [#68](https://github.com/AndrewDongminYoo/ttush_push/issues/68). |
...
| Large text preserves the primary match, coach, and result actions                     | Implemented          | [`game_page_accessibility_test.dart`](../../test/game/view/game_page_accessibility_test.dart) has 200% text scenarios for the match, coach, and result actions. Manual iPad gameplay remains [#69](https://github.com/AndrewDongminYoo/ttush_push/issues/69).                                                                                                                                                                                 |
| Automated checks and manual VoiceOver and TalkBack moves have all passed              | Verification pending | Automated accessibility scenarios pass, but neither they nor their source prove manual device execution. Keep the historical command boxes unchanged, record TalkBack under [#68](https://github.com/AndrewDongminYoo/ttush_push/issues/68), and use [#81](https://github.com/AndrewDongminYoo/ttush_push/issues/81) for the remaining verification and decisions.                                                                            |
